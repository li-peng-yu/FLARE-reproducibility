...
# Train seed 79/80 members for four representative deterministic Table-1 models.
...
BATCH_SIZES=(2 8 4 4 2 8 4 4)
GRAD_ACCUM=(4 1 2 2 4 1 2 2)
...
export HF_HOME=/tmp/x5_det_ens_hf_${RUN_ID}_${RUN_TASK_INDEX}
export TRANSFORMERS_CACHE=${HF_HOME}
export MPLCONFIGDIR=/tmp/x5_det_ens_mpl_${RUN_ID}_${RUN_TASK_INDEX}
