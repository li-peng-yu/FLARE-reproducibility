...
# Evaluate external deterministic seed 81/82 members on the Table-1 path.
...
export HF_HOME=/tmp/x5_det_s45_eval_hf_${RUN_ID}_${RUN_TASK_INDEX}
export TRANSFORMERS_CACHE=${HF_HOME}
export MPLCONFIGDIR=/tmp/x5_det_s45_eval_mpl_${RUN_ID}_${RUN_TASK_INDEX}
