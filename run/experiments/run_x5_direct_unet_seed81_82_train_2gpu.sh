...
# Add seed 81/82 to the matched Direct U-Net control.
# Each member uses the same two-GPU recipe as seeds 78--80.


PROJECT="${PROJECT_ROOT}"
BASE_CONFIG=${PROJECT}/configs/base/x5.yaml
OVERRIDES=(
  "${PROJECT}/configs/flare/stage1_direct_unet50k_seed81.yaml"
  "${PROJECT}/configs/flare/stage1_direct_unet50k_seed82.yaml"
)
