# -*- coding: utf-8 -*-
"""Finite-difference FFT micromagnetic simulator from NeuralMAG.

See the accompanying NeuralMAG LICENSE for upstream attribution.
"""
...
def MFNN(spin): # Spins Shape tensor:(batch*3*32*32)
    _ckpt_model.eval()
    with torch.no_grad():
        spin = spin.permute(2,3,0,1)
        return _ckpt_model(spin).permute(2,3,0,1)
